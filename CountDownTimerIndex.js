...
class CountDown extends React.Component {
  ...
  renderLabel = label => {
    ...
    if (label) {
      return (
        <Text style={[this.props.digitTxtStyle,
          {fontSize: size,marginEnd:3, fontWeight:"bold"}
        ]}>
          {label} 
        </Text>
      );
  ...
  renderCountDown = () => {
    ...
    return (
      ...
      >
        ...
        {timeToShow.includes('H')&& hours!=0 ? this.renderDoubleDigits(timeLabels.h, newTime[1]) : null}
        ...
        {timeToShow.includes('S') && hours==0 ? this.renderDoubleDigits(timeLabels.s, newTime[3]) : null}
      </Component>
    );
  };
